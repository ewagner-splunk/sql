...
# This script pulls a row count for the fact_all_incidents table on both repdb1 and repdb2 and makes a comparison

QUERY1="select count(CONCAT(org_id, \"-\", surfaced_name)) from fact_all_incidents"
